...
const site = {
  ...
  footerServices: [
    { href: '/services', label: 'Preventive Dentistry' },
    { href: '/services', label: 'Routine Dental Exam & Checkup' },
    { href: '/services', label: 'Emergency Dentistry' },
    { href: '/services', label: 'Dental Implants' },
    { href: '/services', label: 'Teeth Whitening' },
    { href: '/services', label: 'Crown and Bridge' },
    { href: '/services', label: 'Dental Fillings' },
    { href: '/services', label: 'Cosmetic Dentistry' },
    { href: '/services', label: 'Root Canal Treatment' },
    { href: '/services', label: 'Tooth Extractions' },
    { href: '/services', label: 'Dentures' },
    { href: '/services', label: 'Post Procedure Care' },
  ],
